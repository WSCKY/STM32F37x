...
#define DEFAULT_PID_INTEGRATION_LIMIT	800.0
#define PID_ROLL_INTEGRATION_LIMIT		200.0
#define PID_PITCH_INTEGRATION_LIMIT		200.0
#define PID_YAW_INTEGRATION_LIMIT		200.0

#define PID_ROLL_GYR_INTEG_LIMIT		100.0
#define PID_PITCH_GRY_INTEG_LIMIT		100.0
#define PID_YAW_GYR_INTEG_LIMIT			100.0

#define MOTOR_MIN_LIMIT					0
#define MOTOR_MAX_LIMIT					800
