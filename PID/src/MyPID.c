...
{
	float PWMValue;
	PWMValue = Thro - PIDGyrPWM.EulerPitch - PIDGyrPWM.EulerYaw;// - PIDPWM.EulerPitch - PIDPWM.EulerYaw;
	...
	PWMValue = Thro + PIDGyrPWM.EulerRoll + PIDGyrPWM.EulerYaw;// + PIDPWM.EulerRoll + PIDPWM.EulerYaw;
	if(PWMValue > MOTOR_MAX_LIMIT) PWMValue = MOTOR_MAX_LIMIT;
	if(PWMValue < MOTOR_MIN_LIMIT) PWMValue = MOTOR_MIN_LIMIT;
